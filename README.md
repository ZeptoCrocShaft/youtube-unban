...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/ZeptoCrocShaft/">ZeptoCrocShaft</a><a href="https://github.com/ZeptoCrocShaft/youtube-unban">/youtube-unban</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
<!-- gbzap-pages-link -->
**Страница сборки:** [https://zeptocrocshaft.github.io/youtube-unban/](https://zeptocrocshaft.github.io/youtube-unban/)

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `ZeptoCrocShaft/youtube-unban`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/ZeptoCrocShaft/youtube-unban/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/ZeptoCrocShaft/youtube-unban/issues/522)
...
- См. [#765](https://github.com/ZeptoCrocShaft/youtube-unban/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/ZeptoCrocShaft/youtube-unban/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/ZeptoCrocShaft/youtube-unban/discussions/251)
...
- См. также [#252](https://github.com/ZeptoCrocShaft/youtube-unban/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/ZeptoCrocShaft/youtube-unban/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/ZeptoCrocShaft/youtube-unban/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/ZeptoCrocShaft/youtube-unban/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/ZeptoCrocShaft/youtube-unban/graphs/contributors)
